    ...
    <div className={`fixed top-0 lg:px-[90px] w-full z-50 ${isScrolled  ? "bg-white" : "bg-transparent"}`}>
      <div className="navbar">
        ...
        <div className="navbar-end">
          <div className="hidden sm:flex justify-center gap-3 font-medium text-base text-white pr-5">
            {/* Favorites */}
          ...
          <div className="relative">
            <button
              ...
              className="btn btn-outline md:px-7 px-5 text-white"
    ...
    >
      ...
      <div className="p-6 lg:p-14 lg:max-h-[100vh] max-h-[90vh] overflow-y-auto">
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <button onClick={()=>setDropdownOpen2(true)} className="text-blue-500">
            Sign Up
          </button>
        </p>
      </div>
